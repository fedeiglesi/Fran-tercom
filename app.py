# =========================================================
# Fran 3.11.6 – Bot Mayorista Inteligente (FAMILIAS + FAISS)
# =========================================================
...
# - Detección de familias (len>=3 + score boost)
# - Fallback progresivo por familia + categoría
# - k dinámico en FAISS según haya/no haya familia
# - Logging de top familias al inicio
# =========================================================
...
# LOGGER
# ------------------------------------------------------------
logger = logging.getLogger("fran316")
...
# =========================================================
# AGENTE PRINCIPAL – VERSIÓN 3.11.6
# =========================================================
...
def health():
    ...
    return jsonify({
        ...
        "architecture": "claude_inspired_families_hybrid",
        "features": [
...
if __name__ == "__main__":
    ...
    logger.info("=" * 60)
    logger.info("🚀 Iniciando Fran 3.11.6 - Motor Híbrido por Familias + FAISS")
    logger.info("=" * 60)
